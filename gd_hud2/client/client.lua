...
Citizen.CreateThread(function()
    while true do
        ...
        SendNUIMessage({
            action = "updateMoney",
            cash = exports.ox_inventory:Search('count', 'money') or 0,
            bank = exports.ox_inventory:Search('count', 'bank') or 0,
            dirty = exports.ox_inventory:Search('count', 'black_money') or 0,
            armor = GetPedArmour(PlayerPedId()) or 0
        })
    end
end)